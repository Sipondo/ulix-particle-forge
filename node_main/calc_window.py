...
from calc_prop_listbox import QDMPropListbox
...
def edge_force_type(input: "Socket", output: "Socket") -> bool:
    """Edge is invalid if it connects different colours"""

    if input.socket_type != output.socket_type:
        print_error("Connecting different colours")
        return False

    return True


Edge.registerEdgeValidator(edge_force_type)
...
class CalculatorWindow(NodeEditorWindow):
    def initUI(self):
        self.name_company = "Pokemon Polaris"
        self.name_product = "Particle Forge"
        ...
        self.setWindowTitle("Particle Forge")
    ...
    def createActions(self):
        ...
        self.actRun = QAction(
            "&Run",
            self,
            statusTip="Run the system",
            triggered=partial(run_nodes, self),
        )
    ...
    def onFileOpen(self):
        fnames, filter = QFileDialog.getOpenFileNames(
            ...
            "../../resources/particle",  # self.getFileDialogDirectory(),
    ...
    def createMenus(self):
        ...
        self.menuBar().addAction(self.actRun)
    ...
    def updateEditMenu(self):
        ...
        self.propertiesListWidget.updateSelection(
            hasMdiChild and active.getSelectedItems() or []
        )
    ...
    def createNodesDock(self):
        ...
        self.propertiesListWidget = QDMPropListbox()
